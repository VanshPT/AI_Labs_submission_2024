...
# Enter coordinates for city 1 (format: x y): 8 3 
# Enter coordinates for city 2 (format: x y): 5 6 
# Enter coordinates for city 3 (format: x y): 1 9 
# Enter coordinates for city 4 (format: x y): 70 5
# Enter coordinates for city 5 (format: x y): 82 2
# Best Route: [4, 3, 2, 1, 0]
# Total Distance: 164.7345587947957